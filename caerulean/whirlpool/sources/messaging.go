...
// Accepts HTTP request and pointer to expected message container.
// Returns error if an error happens on any step, nil otherwise.
...
// Accepts response writer, data to write and HTTP code.
...
// Accepts response writer and message pointer.
...
// Accepts response writer, error to write and HTTP code.
...
// Accepts TCP connection, buffer for reading (should be resetted after each use), requester IP address (as a string) and a pointer to expected message container.
// Returns sender user ID pointer if no error occurs, nil and error otherwise.
...
// Accepts ControlResponseStatus to write, error to write, TCP connection to use and viridian IP address pointer.
