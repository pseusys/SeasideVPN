...
CONNECTION_LINK = f"seaside+{CONNECTION_NODETYPE}://{CONNECTION_ADDRESS}:{CONNECTION_CTRLPORT}/{CONNECTION_ANCHOR}?payload={CONNECTION_PAYLOAD}"
...
def test_parse_connection_link() -> None:
    params_expected = {"payload": CONNECTION_PAYLOAD, "addr": CONNECTION_ADDRESS, "ctrl_port": CONNECTION_CTRLPORT, "anchor": CONNECTION_ANCHOR}
