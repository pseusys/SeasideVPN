...
from sources.automation.testing_client import create_client_certificate_from_env
...
async def client() -> AsyncGenerator[AlgaeClient, None]:
    ...
    yield AlgaeClient.new(cert.address, port, "typhoon", cert.typhoon_public, cert.token, cert.dns)
