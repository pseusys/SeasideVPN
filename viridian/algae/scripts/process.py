...
def bundle() -> None:
    ...
    create_app(str(setup), output=installer_name, main=entrypoint, compressed=True, lazy_install=True, ensure_pip=True, unzip_path=install_cache, pip_args=dependencies, rm_patterns=pycache)
